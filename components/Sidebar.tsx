...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-[240px] xl:w-[280px] flex flex-col h-full gap-2 hidden md:flex shrink-0">
      ...
      <div className="bg-[#121212] rounded-lg border border-white/10 py-4 px-3 flex flex-col gap-1 transition-all duration-300">
      ...
      {/* Library Block */}
      <div className="bg-[#121212] rounded-lg border border-white/10 flex-1 flex flex-col overflow-hidden m-0 transition-all duration-300">
        {/* Library Header */}
